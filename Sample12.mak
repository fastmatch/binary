...
# Link or archive
$(TARGETDIR_all)/Sample12: $(OBJS_all) $(DEPLIBS_all)
	$(LINK.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ $(OBJS_all) $(LDLIBS_all)


# Compile source files into .o files
$(TARGETDIR_all)/sample12.o: src/sample12.cpp $(DEPS_H)
	$(COMPILE.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ src/sample12.cpp
...
.KEEP_STATE:
.KEEP_STATE_FILE:.make.state.samp12.GNU-amd64-Linux
