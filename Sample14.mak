...
# Link or archive
$(TARGETDIR_all)/Sample14: $(OBJS_all) $(DEPLIBS_all)
	$(LINK.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ $(OBJS_all) $(LDLIBS_all)


# Compile source files into .o files
$(TARGETDIR_all)/sample14.o: src/sample14.cpp $(DEPS_H)
	$(COMPILE.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ src/sample14.cpp
...
.KEEP_STATE:
.KEEP_STATE_FILE:.make.state.samp14.GNU-amd64-Linux
