...
TARGETDIR_all=GNU-amd64-Linux/ItchMon


all: $(TARGETDIR_all)/ItchMon
...
# Link or archive
$(TARGETDIR_all)/ItchMon: $(OBJS_all) $(DEPLIBS_all)
...
.KEEP_STATE:
.KEEP_STATE_FILE:.make.state.mon.GNU-amd64-Linux
