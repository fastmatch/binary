...
TARGETDIR_all=GNU-amd64-Linux/Sniper

all: $(TARGETDIR_all)/Sniper
...
# Link or archive
$(TARGETDIR_all)/Sniper: $(OBJS_all) $(DEPLIBS_all)
	$(LINK.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ $(OBJS_all) $(LDLIBS_all)

# Compile source files into .o files
$(TARGETDIR_all)/sniper.o: src/sniper.cpp  $(DEPS_H)
	$(COMPILE.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ src/sniper.cpp
...
$(TARGETDIR_all)/ouch_handlers.o: src/ouch_handlers.cpp  $(DEPS_H)
	$(COMPILE.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ src/ouch_handlers.cpp
...
$(TARGETDIR_all)/ostore.o:  src/ostore.cpp  $(DEPS_H)
	$(COMPILE.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ src/ostore.cpp
...
.KEEP_STATE:
.KEEP_STATE_FILE:.make.state.sniper.GNU-amd64-Linux
