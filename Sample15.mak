...
# Link or archive
$(TARGETDIR_all)/Sample15: $(OBJS_all) $(DEPLIBS_all)
	$(LINK.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ $(OBJS_all) $(LDLIBS_all)


# Compile source files into .o files
$(TARGETDIR_all)/sample15.o: src/sample15.cpp $(DEPS_H)
	$(COMPILE.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ src/sample15.cpp
...
.KEEP_STATE:
.KEEP_STATE_FILE:.make.state.samp15.GNU-amd64-Linux
