...
USERLIBS_all =  
#/home/fxlocus/apps/linux-x86_64/boost_gcc492/boost/lib/libboost_system.a
ifeq ($(onload),true)
...
# Link or archive
$(TARGETDIR_all)/Sample13: $(OBJS_all) $(DEPLIBS_all)
	$(LINK.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ $(OBJS_all) $(LDLIBS_all)


# Compile source files into .o files
$(TARGETDIR_all)/sample13.o: src/sample13.cpp $(DEPS_H)
	$(COMPILE.cc) $(CCFLAGS_all) $(CPPFLAGS_all) -o $@ src/sample13.cpp
...
.KEEP_STATE:
.KEEP_STATE_FILE:.make.state.samp13.GNU-amd64-Linux
